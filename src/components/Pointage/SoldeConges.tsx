  ...
  return (
    <div className="space-y-4 px-5 pt-5">
      <div className="bg-surface p-5 rounded-[24px] card-shadow text-center space-y-4 border border-border/50">
        <div className="relative w-32 h-32 mx-auto">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            <span className="text-[8px] font-bold text-text-secondary uppercase tracking-widest">Jours restants</span>
          </div>
        </div>

        <div className="grid grid-cols-2 gap-3 pt-3 border-t border-border">
          <div className="text-left">
            <p className="text-[8px] font-bold text-text-secondary uppercase tracking-widest mb-0.5">Acquis</p>
            <p className="text-base font-bold text-text-primary">25.0</p>
          </div>
          <div className="text-left">
            <p className="text-[8px] font-bold text-text-secondary uppercase tracking-widest mb-0.5">Pris</p>
      ...
      <div className="space-y-2.5">
        <h4 className="text-[9px] font-bold text-text-secondary uppercase tracking-widest px-2 opacity-60">Dernières demandes</h4>
        {[
          { type: 'CP', date: '15/04 → 22/04', status: 'pending', label: 'Congés Payés' },
          { type: 'OFF', date: '05/04/2026', status: 'approved', label: 'Jour de repos' },
        ].map((item, i) => (
